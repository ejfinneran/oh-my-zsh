# Based on the Fino theme by Max Masnick (http://max.masnick.me)
# Customized slightly by E.J. Finneran (ej.finneran@gmail.com)
...
local git_info='$(git_prompt_info)$(need_push)'
